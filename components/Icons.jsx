...
const paths = {
  ...
  x: <path d="M4 4l16 16M20 4L4 20" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />,
  instagram: (
    <>
  ...
  facebook: (
    <>
      <path d="M18.4 3H5.6a2.6 2.6 0 0 0-2.6 2.6v12.8a2.6 2.6 0 0 0 2.6 2.6h6.4V14h-2v-2.4h2V10c0-2 1.2-3 2.9-3 .8 0 1.6.1 1.8.1v2.1h-1.2c-1 0-1.2.5-1.2 1.2v1.6h2.4l-.3 2.4h-2.1v6.8h4.1a2.6 2.6 0 0 0 2.6-2.6V5.6a2.6 2.6 0 0 0-2.6-2.6Z" />
    </>
  ),
  youtube: (
    <>
      <path d="M21.6 6.8c-.4-1.6-1.8-2.8-3.6-2.8H5.6c-2.2 0-3.8 1.6-3.8 3.8v7.2c0 2.2 1.6 3.8 3.8 3.8h12.4c1.8 0 3.2-1.2 3.6-2.8v-9.2Z" />
      <path d="m10 14.4 4.8-3.2-4.8-3.2v6.4Z" />
    </>
  ),
  reddit: (
    <>
      ...
      <path d="M9 15c.8.6 2.2.8 3 .8s2.2-.2 3-.8" />
      <path d="M2.8 11.2c-1.2 0-2.2 1-2.2 2.2s1 2.2 2.2 2.2 1.6-.8 1.6-1.6" />
      <path d="M21.2 11.2c1.2 0 2.2 1 2.2 2.2s-1 2.2-2.2 2.2-1.6-.8-1.6-1.6" />
      <circle cx="12" cy="3.2" r="1.6" />
      <path d="M5.4 5.2C3.4 3.8 1.2 2.8.8 5.8c-.4 2.4 1 3.4 2.6 4.4M18.6 5.2c2 -1.4 4.2-2.4 4.6.6.4 2.4-1 3.4-2.6 4.4" />
    </>
  ),
  tiktok: (
    <>
      <path d="M16.6 5.4v8c0 1.8-1.4 3.2-3.2 3.2s-3.2-1.4-3.2-3.2" />
      <path d="M9.8 3.4v10.2c0 1.2-1 2.2-2.2 2.2s-2.2-1-2.2-2.2 1-2.2 2.2-2.2" />
      <path d="M13.4 1.4v12.2c0 2.8-2.2 5-5 5s-5-2.2-5-5" />
    </>
  ),
  linkedin: (
    <>
      <rect x="2.8" y="2.8" width="18.4" height="18.4" rx="2.2" />
      <path d="M8.4 9.8v6.8M8.4 7.2v.01M6.2 16.6h4.4M18.4 16.6v-3.6c0-2-1.2-3.4-2.8-3.4-1.2 0-2 .8-2.4 1.6v-1.4h-4.4v6.8h4.4v-3.6c0-.8.4-1.4 1-1.4.6 0 1 .6 1 1.4v3.6h4.4Z" />
    </>
  ),
};
