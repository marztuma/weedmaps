...
export function mailStatus() {
  ...
  return {
    ...
    /* On the shared sender nothing reaches a customer, however healthy
       everything else looks. That is worth stating plainly on the panel rather
       than leaving someone to infer it from a failed send. */
    usingTestSender: Boolean(from && from.includes(TEST_SENDER)),
  };
}
